    ...
    render() {
        ...
        return(
            ...
            <div className="forecast">
                        ...
                        <div className='display-date'>{this.props.time1}</div>
                    ...
                    <div className="forecast">
                        <div className='display-date'>{this.props.time2}</div>
                    ...
                    <div className="forecast">
                        <div className='display-date'>{this.props.time3}</div>
                    ...
                    <div className="forecast">
                        <div className='display-date'>{this.props.time4}</div>
                    ...
                    <div className="forecast">
                        <div className='display-date'>{this.props.time5}</div>
