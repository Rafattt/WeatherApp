...
class App extends Component {
    constructor(props) {
        ...
        this.forecastTemperature = this.forecastTemperature.bind(this);
        this.getTime = this.getTimeH.bind(this);
    ...
    getData(currentW, forecastW, weatherL){ //gets weather data from api
        ...
        let forecast = forecastW + weatherL +'&CNT=5&APPID=' + key;
    ...
    conditionIcon(condition){ //changing weather icon according to weather data from API
        switch(condition) {
            case 'Rain':
                return require('./icons/rainy-6.svg').default
            
            case 'Clear':
                return require('./icons/day.svg').default

            case 'Thunderstorm':
                return require('./icons/thunder.svg').default

            case 'Drizzle':
                return require('./icons/rainy-4.svg').default

            case 'Snow':
                return require('./icons/snowy-6.svg').default

            case 'Mist':
            return require('./icons/cloudy.svg').default

            case 'Shower Rain':
                return require('./icons/rainy-7.svg').default

            case 'scattered clouds':
                return require('./icons/cloudy-day-1.svg').default

            case 'few clouds':
                return require('./icons/cloudy-day-2.svg').default

            case 'broken clouds':
                return require('./icons/cloudy-day-3.svg').default
